...
const findExisting = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const basicauth = (0, utils_1.handleAuth)();
    const res = yield fetch(`${utils_1.URL}?spaceKey=${(0, core_1.getInput)('spacekey')}&title=${(0, core_1.getInput)('title')}`, {
        headers: {
            Authorization: `Basic ${basicauth}`
        }
    });
...
const handleVersion = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const basicauth = (0, utils_1.handleAuth)();
    const res = yield fetch(`${utils_1.URL}/${id}`, {
        headers: {
            Authorization: `Basic ${basicauth}`
        }
    });
...
const showdown_1 = __nccwpck_require__(872);
const isCloud = (url) => {
