...
const node_fetch_1 = __importDefault(__nccwpck_require3_(4429));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const utils_1 = __nccwpck_require3_(918);
const api_1 = __nccwpck_require3_(8947);
...
const showdown_1 = __nccwpck_require3_(1872);
const isCloud = (url) => {
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __nccwpck_require3_(1267),
...
if (!globalThis.ReadableStream) {
  ...
  try {
    const process = __nccwpck_require3_(7742)
    const { emitWarning } = process
    try {
      process.emitWarning = () => {}
      Object.assign(globalThis, __nccwpck_require3_(2477))
    ...
    Object.assign(globalThis, __nccwpck_require3_(1452))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require3_(1410);
...
var node_domexception = __nccwpck_require3_(7760);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require3_(3213);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require3_(1410);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require3_(8572);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require3_(1410);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require3_(3213);
...
var esm_min = __nccwpck_require3_(8010);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require3_.e(/* import() */ 37).then(__nccwpck_require3_.bind(__nccwpck_require3_, 4037));
...
var from = __nccwpck_require3_(2777);
