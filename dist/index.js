...
exports.handleVersion = exports.findExisting = exports.updateContent = exports.publishContent = void 0;
const core_1 = __nccwpck_require9_(2186);
const utils_1 = __nccwpck_require9_(918);
const node_fetch_1 = __importDefault(__nccwpck_require9_(4429));
const publishContent = (content) => {
    ...
    (0, node_fetch_1.default)(utils_1.URL, {
        method: 'POST',
        headers: {
...
const updateContent = (content, id) => __awaiter(void 0, void 0, void 0, function* () {
    const basicauth = (0, utils_1.handleAuth)();
    const newVersion = yield (0, exports.handleVersion)(id);
    const payload = {
        id,
        type: 'page',
        title: (0, core_1.getInput)('title'),
    ...
    (0, node_fetch_1.default)(`${utils_1.URL}/${id}`, {
        method: 'PUT',
        headers: {
            Authorization: `Basic ${basicauth}`,
            'Content-Type': 'application/json'
...
const findExisting = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const basicauth = (0, utils_1.handleAuth)();
    const res = yield (0, node_fetch_1.default)(`${utils_1.URL}?spaceKey=${(0, core_1.getInput)('spacekey')}&title=${(0, core_1.getInput)('title')}`, {
        headers: {
            Authorization: `Basic ${basicauth}`
        }
    });
...
const handleVersion = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const basicauth = (0, utils_1.handleAuth)();
    const res = yield (0, node_fetch_1.default)(`${utils_1.URL}/${id}`, {
        headers: {
            Authorization: `Basic ${basicauth}`
        }
    });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const utils_1 = __nccwpck_require9_(918);
const api_1 = __nccwpck_require9_(8947);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.URL = exports.convertFn = exports.checkInputs = exports.handleAuth = exports.isCloud = void 0;
const core_1 = __nccwpck_require9_(2186);
const fs_1 = __nccwpck_require9_(7147);
const showdown_1 = __nccwpck_require9_(1872);
const isCloud = (url) => {
...
exports.URL = `${(0, core_1.getInput)('cnflurl')}${(0, exports.isCloud)((0, core_1.getInput)('cnflurl')) && 'wiki'}/rest/api/content`;
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __nccwpck_require9_(1267),
...
"use strict";
module.exports = __nccwpck_require8_(300);
...
"use strict";
module.exports = __nccwpck_require8_(742);
...
"use strict";
module.exports = __nccwpck_require8_(267);

/***/ }),

/***/ 8572:
/***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require9_) => {
...
if (!globalThis.ReadableStream) {
  ...
  try {
    const process = __nccwpck_require9_(7742)
    const { emitWarning } = process
    try {
      process.emitWarning = () => {}
      Object.assign(globalThis, __nccwpck_require9_(2477))
    ...
    Object.assign(globalThis, __nccwpck_require9_(1452))
  }
}
...
try {
  ...
  const { Blob } = __nccwpck_require9_(4300)
...
/***/ 3213:
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __nccwpck_require9_) => {

"use strict";
/* harmony export */ __nccwpck_require9_.d(__webpack_exports__, {
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require9_(1410);
...
// EXPORTS
__nccwpck_require9_.d(__webpack_exports__, {
...
const external_node_fs_namespaceObject = __nccwpck_require8_(561);
;// CONCATENATED MODULE: external "node:path"
const external_node_path_namespaceObject = __nccwpck_require8_(411);
// EXTERNAL MODULE: ./node_modules/node-domexception/index.js
var node_domexception = __nccwpck_require9_(7760);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require9_(3213);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require9_(1410);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require9_(8572);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require9_(1410);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require9_(3213);
...
const external_node_http_namespaceObject = __nccwpck_require8_(849);
;// CONCATENATED MODULE: external "node:https"
const external_node_https_namespaceObject = __nccwpck_require8_(286);
;// CONCATENATED MODULE: external "node:zlib"
const external_node_zlib_namespaceObject = __nccwpck_require8_(628);
;// CONCATENATED MODULE: external "node:stream"
const external_node_stream_namespaceObject = __nccwpck_require8_(492);
;// CONCATENATED MODULE: external "node:buffer"
const external_node_buffer_namespaceObject = __nccwpck_require8_(254);
...
const external_node_util_namespaceObject = __nccwpck_require8_(261);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require9_(1410);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __nccwpck_require9_(8010);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require9_.e(/* import() */ 37).then(__nccwpck_require9_.bind(__nccwpck_require9_, 4037));
...
const external_node_url_namespaceObject = __nccwpck_require8_(41);
...
const external_node_net_namespaceObject = __nccwpck_require8_(503);
...
var from = __nccwpck_require9_(2777);
...
/******/ 	__nccwpck_require9_.m = __webpack_modules__;
/******/ 	
/************************************************************************/
/******/ 	/* webpack/runtime/define property getters */
/******/ 	(() => {
/******/ 		// define getter functions for harmony exports
/******/ 		__nccwpck_require9_.d = (exports, definition) => {
/******/ 			for(var key in definition) {
/******/ 				if(__nccwpck_require9_.o(definition, key) && !__nccwpck_require9_.o(exports, key)) {
...
/******/ 	(() => {
/******/ 		__nccwpck_require9_.f = {};
/******/ 		// This file contains only the entry chunk.
/******/ 		// The chunk loading function for additional chunks
/******/ 		__nccwpck_require9_.e = (chunkId) => {
/******/ 			return Promise.all(Object.keys(__nccwpck_require9_.f).reduce((promises, key) => {
/******/ 				__nccwpck_require9_.f[key](chunkId, promises);
/******/ 				return promises;
/******/ 			}, []));
/******/ 		};
/******/ 	})();
...
/******/ 	(() => {
/******/ 		__nccwpck_require9_.o = (obj, prop) => (Object.prototype.hasOwnProperty.call(obj, prop))
/******/ 	})();
/******/ 	
...
/******/ 				if(__nccwpck_require9_.o(moreModules, moduleId)) {
/******/ 					__nccwpck_require9_.m[moduleId] = moreModules[moduleId];
/******/ 				}
/******/ 			}
/******/ 			if(runtime) runtime(__nccwpck_require9_);
...
/******/ 		__nccwpck_require9_.f.require = (chunkId, promises) => {
/******/ 			// "1" is the signal for "already loaded"
/******/ 			if(!installedChunks[chunkId]) {
/******/ 				if(true) { // all chunks have JS
/******/ 					installChunk(require("./" + __nccwpck_require9_.u(chunkId)));
/******/ 				} else {}
/******/ 			}
/******/ 		};
/******/ 		
...
"use strict";
module.exports = __nccwpck_require7_(254);
...
"use strict";
module.exports = __nccwpck_require7_(561);
...
"use strict";
module.exports = __nccwpck_require7_(849);
...
"use strict";
module.exports = __nccwpck_require7_(286);
...
"use strict";
module.exports = __nccwpck_require7_(503);
...
"use strict";
module.exports = __nccwpck_require7_(411);
...
"use strict";
module.exports = __nccwpck_require7_(742);
...
"use strict";
module.exports = __nccwpck_require7_(41);
...
"use strict";
module.exports = __nccwpck_require7_(628);
...
"use strict";
module.exports = __nccwpck_require6_(254);
...
"use strict";
module.exports = __nccwpck_require6_(561);
...
"use strict";
module.exports = __nccwpck_require6_(849);
...
"use strict";
module.exports = __nccwpck_require6_(286);
...
"use strict";
module.exports = __nccwpck_require6_(503);
...
"use strict";
module.exports = __nccwpck_require6_(411);
...
"use strict";
module.exports = __nccwpck_require6_(742);
...
"use strict";
module.exports = __nccwpck_require6_(41);
...
"use strict";
module.exports = __nccwpck_require6_(628);
...
"use strict";
module.exports = __nccwpck_require5_(254);
...
"use strict";
module.exports = __nccwpck_require5_(561);
...
"use strict";
module.exports = __nccwpck_require5_(849);
...
"use strict";
module.exports = __nccwpck_require5_(286);
...
"use strict";
module.exports = __nccwpck_require5_(503);
...
"use strict";
module.exports = __nccwpck_require5_(411);
...
"use strict";
module.exports = __nccwpck_require5_(41);
...
"use strict";
module.exports = __nccwpck_require5_(628);
